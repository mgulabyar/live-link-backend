...
const saveLink = async (req, res) => {
  try {
    const { linkId, componentName, excelFileId, excelFileName, sheetName, rangeAddress, type, dataSnapshot } = req.body;
...
const updateLink = async (req, res) => {
  try {
    const { linkId } = req.params;
    const { dataSnapshot, componentName } = req.body;

    const updateFields = {};
    if (dataSnapshot) updateFields.dataSnapshot = dataSnapshot;
